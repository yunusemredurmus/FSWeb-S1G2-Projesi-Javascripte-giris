...
*/
 for (let i = 5; i>1; i--) { console.log(i+ " "+ "küçük maymun yatakta zıplamış, biri düşüp başını çarpmış, Anne doktoru aramış, Doktor çok kmış: Bir daha yatakta zıplamak yok!"); 
  }
